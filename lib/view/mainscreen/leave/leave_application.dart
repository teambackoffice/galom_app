...
class _LeaveListPageState extends State<LeaveListPage> {
  final List<LeaveRequest> leaveHistory = const [
    LeaveRequest(
      type: 'Annual Leave',
      dateRange: '15 Apr – 18 Apr',
      days: 4,
      status: LeaveStatus.approved,
      appliedOn: '10 Apr, 2024',
      reason: 'Taking time off for a family vacation.',
    ),
    LeaveRequest(
      type: 'Sick Leave',
      dateRange: '02 May – 03 May',
      days: 1.5,
      status: LeaveStatus.pending,
      appliedOn: '01 May, 2024',
      reason: 'Feeling unwell. Need to rest for a couple of days.',
    ),
    LeaveRequest(
      type: 'Casual Leave',
      dateRange: '10 Jun – 10 Jun',
      days: 1,
      status: LeaveStatus.rejected,
      appliedOn: '05 Jun, 2024',
      reason: 'Personal errands to attend to.',
    ),
    LeaveRequest(
      type: 'Maternity Leave',
      dateRange: '01 Aug – 01 Nov',
      days: 90,
      status: LeaveStatus.approved,
      appliedOn: '15 Jul, 2024',
    ),
  ];

  int get totalLeaves => 12;
  int get availableLeaves => 8;
  int get usedLeaves => 4;
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  LeaveCard(leave: leaveHistory[index]),
            ),
          ),
        ],
      ),
  ...
  Widget _buildBalanceStrip() {
    return Container(
      ...
      child: IntrinsicHeight(
        child: Row(
          children: [
            _balanceItem('$totalLeaves', 'Total', const Color(0xFF1A1A1A)),
            _verticalDivider(),
            _balanceItem(
              '$availableLeaves',
              'Available',
            ...
            _verticalDivider(),
            _balanceItem('$usedLeaves', 'Used', const Color(0xFFA32D2D)),
          ],
        ),
      ),
    );
  ...
  Widget _verticalDivider() {
    return Container(width: 0.5, color: const Color(0xFFE0E0E0));
  }
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow(Icons.calendar_today_outlined, 'Date Range', leave.dateRange),
                    const SizedBox(height: 16),
                    _buildDetailRow(Icons.access_time_rounded, 'Duration', _daysLabel),
                    if (leave.appliedOn != null) ...[
                      const SizedBox(height: 16),
                      _buildDetailRow(Icons.edit_calendar_outlined, 'Applied On', leave.appliedOn!),
                    ],
                  ],
                ),
              ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Insufficient balance or team capacity constraints.',
                        style: TextStyle(
                          fontSize: 14,
                          color: Color(0xFF1A1A1A),
                          height: 1.4,
